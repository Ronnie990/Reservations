...
$(document).ready(function(){
  ...
  window.onload = function() {
	...
	if($('#login_e').hasClass("valid")){
		...
		$.ajax({
					type: 'POST',
					url: 'http://ec2-3-14-111-114.us-east-2.compute.amazonaws.com:5144/consultas.php',
	...
	if(x==1){
		$.ajax({
					type: 'POST',
					url: 'http://ec2-3-14-111-114.us-east-2.compute.amazonaws.com:5144/updates.php',
